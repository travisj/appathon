		 ...
		 weather:
			...
			tv: [
				{name:'60 Minutes', image_url:'http://images.zap2it.com/images/tv-EP00000035/60-minutes-5.jpg', options:[
					{ segment: 59423, name: 'The show will start within 60 minutes.'}
					{ segment: 59424, name: 'The show will start within 30 minutes.'}
					{ segment: 59425, name: 'The show is currently running.'}
					{ segment: 59426, name: 'The show ended within 30 minutes.'}
					{ segment: 59427, name: 'The show ended within 60 minutes.'}]}
				{name:'Austin City Limits', image_url:'http://images.zap2it.com/images/tv-EP00000439/austin-city-limits-5.jpg', options:[
					{ segment: 59428, name: 'The show will start within 60 minutes.'}
					{ segment: 59429, name: 'The show will start within 30 minutes.'}
					{ segment: 59430, name: 'The show is currently running.'}
					{ segment: 59431, name: 'The show ended within 30 minutes.'}
					{ segment: 59432, name: 'The show ended within 60 minutes.'}]}
				{name:'Babar', image_url:'http://images.zap2it.com/images/tv-EP00000455/babar-2.jpg', options:[
					{ segment: 59433, name: 'The show will start within 60 minutes.'}
					{ segment: 59434, name: 'The show will start within 30 minutes.'}
					{ segment: 59435, name: 'The show is currently running.'}
					{ segment: 59436, name: 'The show ended within 30 minutes.'}
					{ segment: 59437, name: 'The show ended within 60 minutes.'}]}]
			stocks:[
				{ name: 'MSFT', options: [
